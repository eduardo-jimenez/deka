...
MIN_TOTAL_TIME:float = 24 * 60
MAX_TOTAL_TIME:float = 4000
TOTAL_TIME_STEP:float = 10.0
...
NUM_TOTAL_RUN_TIME_DIVS:int = int((MAX_TOTAL_TIME_RUNS - MIN_TOTAL_TIME_RUNS) / TOTAL_TIME_STEP)
NUM_TOTAL_ZONES_TIME_DIVS:int = int((MAX_TOTAL_TIME_ZONES - MIN_TOTAL_TIME_ZONES) / TOTAL_TIME_STEP)
